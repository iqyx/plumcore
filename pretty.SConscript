...
env['IMAGEELFSIZECOMSTR'] = cformat("{c.blue}{c.bold}\nGenerated ELF image info:{c.default}")
env['IMAGEELFHDRCOMSTR'] = cformat("{c.blue}{c.bold}\nELF image program headers:{c.default}")
