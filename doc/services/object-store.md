...
- open for writing: do not consider the supplied file name, lock the object store for writing, find the first empty slot, keep it locked until the file is closed
