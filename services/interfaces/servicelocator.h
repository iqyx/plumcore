...
enum iservicelocator_type {
	...
	ISERVICELOCATOR_TYPE_FB,
	ISERVICELOCATOR_TYPE_I2C,
	ISERVICELOCATOR_TYPE_EVENT,
	ISERVICELOCATOR_TYPE_WAVEFORM_SINK,
	ISERVICELOCATOR_TYPE_BEEPER,
	ISERVICELOCATOR_TYPE_CONF,
	ISERVICELOCATOR_TYPE_POWER,
