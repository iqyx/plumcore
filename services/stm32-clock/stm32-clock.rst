...
- create a clock tree with dependencies and reference counting to automatically enable/disable
  bus and peripheral clocks when needed

The current state of the service is half-done PoC with a FSM to handle oscillator startup and a basic
method of PLL configuration. Use at your own risk, YMMV.
