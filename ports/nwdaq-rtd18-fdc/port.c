 ...
 **********************************************************************************************************************/
...
#if defined(CONFIG_NWDAQ_RTD18_FDC_ENABLE_SERIAL_CONSOLE)
	Stm32Uart uart2;
	static void console_init(void) {
		...
		uart2.uart.vmt->set_bitrate(&uart2.uart, CONFIG_NWDAQ_RTD18_FDC_CONSOLE_SPEED);
...
#if defined(CONFIG_NWDAQ_RTD18_FDC_ENABLE_LEDS)
