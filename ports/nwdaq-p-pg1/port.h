 ...
 *
 * nwdaq-p-pg1 port-specific configuration
 *
 ...
 * GPIO definitions
 */
#define P1_H_EN_PORT GPIOC
#define P1_H_EN_PIN GPIO6
#define P1_L_EN_PORT GPIOB
#define P1_L_EN_PIN GPIO1

#define P2_H_EN_PORT GPIOB
#define P2_H_EN_PIN GPIO9
#define P2_L_EN_PORT GPIOB
#define P2_L_EN_PIN GPIO2

#define VBUS_H_EN_PORT GPIOB
#define VBUS_H_EN_PIN GPIO8
